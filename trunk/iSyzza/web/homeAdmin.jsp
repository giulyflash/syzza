...
<html>
    ...
    <body>
        <div id="tudo">
            ...
            <div id="conteudo">
                <h3>Menu</h3>
                <h5><a href="main.do?action=adminFunc">Administra&ccedil;&atilde;o de Funcion&aacute;rios</a></h5>
                <h5><a href="main.do?action=adminItens">Administra&ccedil;&atilde;o de Itens</a></h5>
            </div>
            <div class="footer">
